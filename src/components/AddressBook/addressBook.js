...
const AddressBook = (props) => {
    ...
    const validateData = () => {
        let error = formError;
        if (!formValue.firstName.match('^[A-Z]{1}[A-Za-z\\s]{2,}$')) {
        ...
        if (!formValue.lastName.match('^[A-Z]{1}[A-Za-z\\s]{2,}$')) {
        ...
        <form action="#" className="form" onReset={() => reset()} onSubmit={save}>
            ...
            <div className="form-constrains">
                <div className="row-content">
                    <label htmlFor="name" className="label text name">First Name</label>
                    <br/>
                    <input type="text" className="input" id="name" name="firstName" placeholder="Your name" autoComplete="off"
                     value={formValue.firstName} onChange={changeValue} required />
                    {formError.firstName && <div className="error">{formError.firstName}</div>}
                </div>
                <div className="row-content">
                    <label htmlFor="name" className="label text name">Last Name</label>
                    <br/>
                    <input type="text" className="input" id="name" name="lastName" placeholder="Your name" autoComplete="off"
                     value={formValue.lastName} onChange={changeValue} required />
                    {formError.lastName && <div className="error">{formError.lastName}</div>}
                </div>
                <div className="row-content">
                    <label htmlFor="name" className="label text name">Email</label>
                    <br/>
                    <input type="text" className="input" id="name" name="email" placeholder="Your name" autoComplete="off"
                     value={formValue.email} onChange={changeValue} required />
